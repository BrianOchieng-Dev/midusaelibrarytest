...
export const BOOKS_DATA: Book[] = [
  {
    ...
    coverPattern: 'waves',
    description: 'Master the neurological triggers that transform disciplined action from a battle of willpower into an automatic daily reflex. Learn dopamine baseline restoration, environment redesign, and identity-based habit compounding in high-resolution PDF format for only 100 KES.',
    keyTakeaways: [
