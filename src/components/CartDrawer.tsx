  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex">
        <div className="w-screen max-w-md bg-white border-l border-slate-200 shadow-2xl flex flex-col h-full z-50 animate-slideLeft">
          ...
          {items.length === 0 ? (
            <div className="flex-1 p-6 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-sm text-slate-500 max-w-xs mb-6">
                Explore our bestsellers in Self Development, Business, Psychology, Finance, and Entrepreneurship.
              </p>
              <button
                onClick={onClose}
                className="px-6 py-3 rounded-xl text-sm font-bold bg-blue-600 hover:bg-blue-700 text-white shadow-xs cursor-pointer"
              >
                Browse Library
              </button>
            </div>
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                ...
                <div className="flex items-center justify-between pb-2.5 border-b border-slate-100 text-xs sm:text-sm text-slate-500 font-medium">
                  <span>Selected Books</span>
                  {showClearConfirm ? (
                    <div className="flex items-center gap-2">
                      <span className="text-rose-600 font-bold text-xs">Clear all?</span>
                      <button
                        onClick={() => {
                          onClearCart();
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 rounded bg-slate-200 text-slate-700 text-xs cursor-pointer"
                      >
                        Cancel
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      className="text-slate-400 hover:text-rose-600 transition-colors flex items-center gap-1.5 cursor-pointer"
                    >
              ...
              <div className="p-4 sm:p-5 bg-slate-50 border-t border-slate-200 space-y-3.5">
                <div className="space-y-1.5 text-xs sm:text-sm">
                  <div className="flex justify-between text-slate-500">
                    <span>Delivery</span>
                    <span className="text-emerald-600 font-medium">Instant Unique PDF Link</span>
                  </div>
                  <div className="flex justify-between text-base sm:text-lg font-bold text-slate-900 pt-2 border-t border-slate-200">
                    <span>Total Amount</span>
                    <span className="text-blue-600 font-extrabold">{formatPrice(totalKES)}</span>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-xl font-bold text-sm sm:text-base bg-emerald-600 hover:bg-emerald-700 text-white flex items-center justify-center gap-2.5 shadow-sm transition-all active:scale-95 cursor-pointer"
                >
                  <Smartphone className="w-4.5 h-4.5" />
                  <span>Pay {formatPrice(totalKES)} with M-Pesa</span>
                ...
                <a
                  ...
                  className="w-full py-2.5 px-4 rounded-xl font-semibold text-xs sm:text-sm text-emerald-800 bg-emerald-100/70 hover:bg-emerald-100 border border-emerald-200/80 flex items-center justify-center gap-2 transition-colors"
                >
